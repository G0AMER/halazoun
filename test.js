...
contract("SnailMarket", (accounts) => {
    ...
    it("should add snails and retrieve their details", async () => {
        // Add snails
        await contract.addSnail("Garden Snail", web3.utils.toWei("0.001", "ether"), 50);
        await contract.addSnail("African Snail", web3.utils.toWei("0.002", "ether"), 30);
        await contract.addSnail("Mystery Snail", web3.utils.toWei("0.0015", "ether"), 20);
     ...
     /*
           ...
           it("should revert if trying to buy more snails than available", async () => {
               try {
                   ...
                   assert.equal(error.reason, "Insufficient stock");
           ...
           it("should revert if incorrect ETH is sent for a purchase", async () => {
               try {
                   ...
                   assert.equal(error.reason, "Incorrect ETH sent");
